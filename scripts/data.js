...
var DATA = {
  ...
  bachelorette: {
    ...
    travel: {
      ...
      title: "Airport & Rides",
      note: "We will Uber to and from the airport, about a 30 to 40 minute drive, and we have a driver with a minivan for the group, plus two cars that hold five each, a convertible BMW and a Toyota Highlander, or you can Uber back. If you fly in at a different time, plan to Uber to the house and back on your own."
    },
